# pac-power
This is my very first time creating a respository on GitHub.

#Create Pac-Man from scratch in python with pygame!!
import copy
...
player_images = []
for i in range(1, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'SVG/player_images/{i}.png'), (45, 45)))
blinky_img = pygame.transform.scale(pygame.image.load(f'SVG/ghost_images/red.png'), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(f'SVG/ghost_images/pink.png'), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(f'SVG/ghost_images/cyan.png'), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(f'SVG/ghost_images/orange.png'), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(f'SVG/ghost_images/powerup.png'), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(f'SVG/ghost_images/deadghost.png'), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
